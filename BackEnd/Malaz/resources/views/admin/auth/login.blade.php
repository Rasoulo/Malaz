...
<head>
    ...
    <style>
        ...
        :root {
            --primary: #B8860B;
            /* Dark Goldenrod - between gold and brown */
                ...
                <div>
                    ...
                    <div class="relative rounded-lg shadow-sm">
                        <input type="email" name="email" value="{{ old('email') }}"
                            ...
                            placeholder="admin@malaz.com" required autofocus>
                ...
                <div>
                    ...
                    <div class="relative rounded-lg shadow-sm">
                        ...
                        <button type="button" onclick="togglePassword()"
                            class="absolute inset-y-0 right-0 pr-3 flex items-center" style="color: var(--primary)">
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center">
                        <input type="checkbox" id="remember" name="remember"
                            class="h-4 w-4 rounded border-gray-300 focus:outline-none" style="color: var(--primary)">
            ...
            <div class="mt-8 p-4 bg-gray-50 rounded-lg border border-gray-200">
                <div class="flex items-start">
                    ...
                    <div class="ml-3">
                        ...
                        <p class="mt-1 text-xs text-gray-600">This portal is restricted to authorized Malaz
